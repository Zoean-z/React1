...
function StrategyPage() {
  ...
  const heatmapRows = [
    [0.1, 0.15, 0.18, 0.3, 0.12, 0.1, 0.08],
    [0.08, 0.2, 0.24, 0.38, 0.18, 0.12, 0.1],
    [0.06, 0.12, 0.18, 0.22, 0.11, 0.1, 0.08],
    [0.08, 0.14, 0.2, 0.26, 0.13, 0.11, 0.09],
    [0.1, 0.16, 0.22, 0.18, 0.15, 0.14, 0.35],
    [0.06, 0.1, 0.12, 0.16, 0.14, 0.1, 0.09]
  ];
